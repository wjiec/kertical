...
type ExternalProxyService struct {
	...
	// +optional
	// +kubebuilder:validation:Optional
	ExternalProxyServiceMeta `json:"metadata,omitempty"`
...
// ExternalProxyServiceMeta contains metadata information for service in ExternalProxy.
type ExternalProxyServiceMeta struct {
...
type ExternalProxyIngress struct {
	...
	// +optional
	// +kubebuilder:validation:Optional
	ExternalProxyIngressMeta `json:"metadata,omitempty"`
...
// ExternalProxyIngressMeta contains metadata information for ingress in ExternalProxy.
type ExternalProxyIngressMeta struct {
	// Name must be unique within a namespace. Is required when creating resources, although
	// some resources may allow a client to request the generation of an appropriate name
	// automatically. Name is primarily intended for creation idempotence and configuration
	// definition.
...
// +kubebuilder:resource:categories=kertical,shortName=kep
